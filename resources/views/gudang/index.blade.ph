    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="text-2xl font-bold text-gray-800 mt-1">
                    {{ $totalStokFisik ?? $barangs->sum('stok') }}
                </div>
                    ...
                    @forelse($pembelians as $po)
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                <a href="{{ route('gudang.terima', $po->id) }}"
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                ...
                                @if($b->stok <= ($b->min_stok ?? 5))
                                    ...
                                    <span class="px-2.5 py-1 text-xs font-semibold bg-red-100 text-red-700 rounded-full">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                ...
                                <form action="{{ route('gudang.updateStok', $b->id) }}"
                                      method="POST">
                                    ...
                                    @if($b->status_update)
                                        ...
                                        <button
                                            type="submit"
                                            class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-1.5 px-4 rounded text-xs transition">
                                    ...
                                    @else
                                        ...
                                        <button
                                            type="submit"
                                            class="bg-red-600 hover:bg-red-700 text-white font-bold py-1.5 px-4 rounded text-xs transition">

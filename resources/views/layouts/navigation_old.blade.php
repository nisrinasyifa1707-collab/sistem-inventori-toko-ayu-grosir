<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Riwayat Transaksi -->
                    <x-nav-link :href="route('transaksi.index')" :active="request()->routeIs('transaksi.index') || request()->routeIs('kasir.laporan')">
                        {{ __('Riwayat Transaksi') }}
                    </x-nav-link>

                    <x-nav-link :href="route('packing.index')" :active="request()->routeIs('packing.*')">
                        {{ __('Packing') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('transaksi.index')" :active="request()->routeIs('transaksi.index') || request()->routeIs('kasir.laporan')">
                {{ __('Riwayat Transaksi') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('packing.index')" :active="request()->routeIs('packing.*')">
                {{ __('Packing') }}
            </x-responsive-nav-link>
